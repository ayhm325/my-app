      ...
      <div className="relative z-10 text-center">
        ...
        <div className="space-y-10">
          <div className="flex flex-col items-center space-y-2 mb-6">
            ...
            <h3 className="text-2xl font-bold mb-1 text-white drop-shadow">لوحة تحكم الأطباء</h3>
            <p className="text-lg text-blue-100 leading-relaxed">وصول سريع وسهل لحالات المرضى.</p>
          </div>
          <div className="flex flex-col items-center space-y-2 mb-6">
            <FaShieldAlt className="text-5xl text-amber-400 drop-shadow-lg mb-2" />
            <h3 className="text-2xl font-bold mb-1 text-white drop-shadow">ملف المريض الشخصي</h3>
            <p className="text-lg text-blue-100 leading-relaxed">تابع نتائجك وتقاريرك الطبية.</p>
          </div>
          <div className="flex flex-col items-center space-y-2">
            <FaLock className="text-5xl text-amber-400 drop-shadow-lg mb-2" />
            <h3 className="text-2xl font-bold mb-1 text-white drop-shadow">آمن وموثوق</h3>
            <p className="text-lg text-blue-100 leading-relaxed">نحمي بياناتك بأعلى معايير الأمان.</p>
          </div>
        </div>
      </div>
    </div>
